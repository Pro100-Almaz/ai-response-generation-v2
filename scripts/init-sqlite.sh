#!/bin/bash
# SQLite initialization script for ai-response-generation-v2
# This script is executed when the SQLite container is first created

set -e

echo "Initializing SQLite database for ai-response-generation-v2..."

# Create data directory if it doesn't exist
mkdir -p /data

# Set database path
DB_PATH="/data/fastapi_db.db"
...
INSERT OR IGNORE INTO database_metadata (key, value) VALUES ('initialized', 'ai-response-generation-v2');
