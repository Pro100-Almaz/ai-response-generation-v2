...
from ai_response_generation_v2.application.dtos.artifact import (
...
from ai_response_generation_v2.application.exceptions import (
...
from ai_response_generation_v2.application.interfaces.cache import CacheProtocol
from ai_response_generation_v2.application.interfaces.http_clients import (
    ExternalMuseumAPIProtocol,
    PublicCatalogAPIProtocol,
)
from ai_response_generation_v2.application.interfaces.mappers import DtoEntityMapperProtocol
from ai_response_generation_v2.application.interfaces.message_broker import MessageBrokerPublisherProtocol
from ai_response_generation_v2.application.interfaces.repositories import ArtifactRepositoryProtocol
...
if TYPE_CHECKING:
    from ai_response_generation_v2.domain.entities.artifact import ArtifactEntity
